...
export const useLabelClasses = ({ variant }: { variant: LabelVariant }) => {
  ...
  const colors = {
    ...
    success:
      "bg-theme-primary-100 text-theme-primary-600 font-medium leading-[125%] dark:bg-transparent dark:text-theme-primary-600 dark:border dark:border-theme-primary-600",
    danger:
